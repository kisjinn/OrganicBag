      ...
      <li class="nav-item">
        ...
        <div id="collapseOne" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="insert_deliveryagent.php">Sign Up</a>
            <a class="collapse-item" href="#">Log In</a>
          </div>
        </div>
      </li>
	   <div class="sidebar-heading">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="insert_product.php"><a href="file:///C:/xampp/htdocs/customer.html"><a>Sign Up</a></a>s</a>
            <a class="collapse-item" href="update_product.php">Log In</a>
          </div>
        </div>
      </li>
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
					...
					<input type="hidden" value="insert_delivery_agent" name="method_name">
